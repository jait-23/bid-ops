...
/**
 * A DTO for the PrimaryEvaluations entity.
 */
public class PrimaryEvaluationsDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        PrimaryEvaluationsDTO primaryEvaluationsDTO = (PrimaryEvaluationsDTO) o;
        if(primaryEvaluationsDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), primaryEvaluationsDTO.getId());
    }

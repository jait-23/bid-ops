...
(function() {
    ...
    BiddersDetail1Controller.$inject = ['$scope', '$rootScope', '$stateParams', '$uibModal', '$http', 'previousState', 'entity', 'Solicitations'];

    function BiddersDetail1Controller($scope, $rootScope, $stateParams, $uibModal, $http, previousState, entity, Solicitations) {
        var vm = this;
        vm.editForm;

(function() {
    ...
    angular
        ...
        .controller('SolicitationsBiddersDetailController', SolicitationsBiddersDetailController);

    SolicitationsBiddersDetailController.$inject = ['$scope', '$rootScope', 'ParseLinks', '$stateParams', '$uibModal', '$http', 'previousState', 'entity', 'pagingParams', 'Solicitations'];

    function SolicitationsBiddersDetailController($scope, $rootScope, ParseLinks, $stateParams, $uibModal, $http, previousState, entity, pagingParams, Solicitations) {
    	var vm = this;
